        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="formu">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#NuevaContraseña" onclick="validarRecuperar(this)">Continuar</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                        <button type="submit" class="btn btn-primary" data-bs-dismiss="modal"  onclick="validarNuevaContraseña(this)">Confirmar</button>
                    </div>
                </form>
            </div>
        </div>
